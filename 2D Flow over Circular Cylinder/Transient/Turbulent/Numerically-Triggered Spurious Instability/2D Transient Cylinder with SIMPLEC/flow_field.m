...
filename = 'cylinder_transient_SIMPLEC.txt'; 
video_filename = 'Transient_Cylinder_SIMPLEC.mp4';
...
for k = 1:num_frames
    ...
    hold on;
    fill(xc_cyl, yc_cyl, [0.4 0.4 0.4], 'EdgeColor', 'k', 'LineWidth', 1.5); % Draw Cylinder
    hold off;
    colormap(gca, 'jet');
    ...
    sgtitle('Transient Flow Over a Circular Cylinder (Re = 10000)');
