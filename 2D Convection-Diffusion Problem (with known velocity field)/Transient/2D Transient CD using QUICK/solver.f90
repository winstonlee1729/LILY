program Transient_CD_QUICK
    ...
    ! Upwind variables for safety ring
    ...
    ae_qk = De - (3.0D0/8.0D0)*alf_e*Fe - (6.0D0/8.0D0)*(1.0D0-alf_e)*Fe &
          - (1.0D0/8.0D0)*(1.0D0-alf_w)*Fw
    ...
    an_qk = Dn - (3.0D0/8.0D0)*alf_n*Fn - (6.0D0/8.0D0)*(1.0D0-alf_n)*Fn &
          - (1.0D0/8.0D0)*(1.0D0-alf_s)*Fs
