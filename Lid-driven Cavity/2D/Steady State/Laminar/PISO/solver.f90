program PISO_Lid_Driven_Cavity
    use omp_lib
    implicit none
        ...
        do k = 1, 100
            ...
            do i = 1, nx
                do j = 1, ny
                    ...
                    pprime(i, j) = (ae * pprime(i+1,j) + aw * pprime(i-1,j) + an * pprime(i,j+1) &
        ...
        do k = 1, 100
            ...
            do i = 1, nx
                do j = 1, ny
                    ...
                    pprime2(i, j) = (ae * pprime2(i+1, j) + aw * pprime2(i-1, j) + an * pprime2(i, j+1)  &
...
! Open the output file
    open(unit=10, file='cavity_PISO.txt', status='unknown')
...
! Deallocate memory
    ...
    stop
end program PISO_Lid_Driven_Cavity