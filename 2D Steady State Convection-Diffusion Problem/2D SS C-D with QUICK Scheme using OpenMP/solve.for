      ...
      ! Parallel solver with Gauss-Seidel Iteration
      write(*,*) 'Starting Calculations on Grid: ', n, 'x', n
...
C$OMP END PARALLEL DO
          ...
          if (mod(iter, 100) == 0 .or. iter == 1) then
              write(*,*) 'Iteration: ', iter, ' | Residual: ', maxres
          endif
      ...
      write(*,*) '------------------------------------'
      write(*,*) 'Parallel Total Iterations: ', iter
      write(*,*) 'Parallel Total Time (Seconds): ',end_time - start_time
      write(*,*) '------------------------------------'      
